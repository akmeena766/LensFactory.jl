...
const ROA = Union{RV, Vector{T}, Matrix{T}} where T <: Float64
...
const DIST_GPC = 3.085677581491367E+25              # One Giga-parsec (in meters)


# Angular units
const ANGLE_MICROARCSEC = 4.848136811095361E-12     # One micro-arcsec (in radian)
const ANGLE_MILLIARCSEC = 4.848136811095361E-09     # One milli-arcsec (in radian)
const ANGLE_ARCSEC      = 4.848136811095361E-06     # One arcsec value (in radian)
