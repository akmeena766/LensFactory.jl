...
"""
    jacobian!(ψxx::ROA, ψyy::ROA, ψxy::ROA, θx::ROA, θy::ROA, D_d::T, θxc::T, θyc::T, k_s::T, θs::T, ϵ::T, pa::T) where T <: Real
"""
function jacobian!(ψxx::ROA, ψyy::ROA, ψxy::ROA, θx::ROA, θy::ROA, D_d::T, θxc::T, θyc::T, k_s::T, θs::T, ϵ::T, pa::T) where T <: Real
   # Get axis-ratio
   q = (1.0 - ϵ) / (1.0 + ϵ)
   θs_p = θs / sqrt(q)
