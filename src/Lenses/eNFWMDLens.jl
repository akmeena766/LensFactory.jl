...
"""
function potential!(ψ::U, θx::S, θy::S, D_d::T, θxc::T, θyc::T, k_s::T, θs::T, ϵ::T, pa::T) where {U<:Real, S<:Real, T<:Real}
   # Get axis-ratio
   q = (1.0 - ϵ) / (1.0 + ϵ)
   θs_p = θs / sqrt(q)
...
"""
function potential!(ψ::U, θx::S, θy::S, D_d::T, θxc::T, θyc::T, k_s::T, θs::T, ϵ::T, pa::T) where {U<:ROA, S<:ROA, T<:Real}
   # Get axis-ratio
   q = (1.0 - ϵ) / (1.0 + ϵ)
   θs_p = θs / sqrt(q)
...
"""
function deflection!(ψx::U, ψy::U, θx::S, θy::S, D_d::T, θxc::T, θyc::T, k_s::T, θs::T, ϵ::T, pa::T) where {U<:Real, S<:Real, T<:Real}
   # Get axis-ratio
   q = (1.0 - ϵ) / (1.0 + ϵ)
   θs_p = θs / sqrt(q)
...
"""
function deflection!(ψx::U, ψy::U, θx::S, θy::S, D_d::T, θxc::T, θyc::T, k_s::T, θs::T, ϵ::T, pa::T) where {U<:ROA, S<:ROA, T<:Real}
   # Get axis-ratio
   q = (1.0 - ϵ) / (1.0 + ϵ)
   θs_p = θs / sqrt(q)
...
"""
function jacobian!(ψxx::U, ψyy::U, ψxy::U, θx::S, θy::S, D_d::T, θxc::T, θyc::T, k_s::T, θs::T, ϵ::T, pa::T) where {U<:Real, S<:Real, T<:Real}
   # Get axis-ratio
   q = (1.0 - ϵ) / (1.0 + ϵ)
   θs_p = θs / sqrt(q)
...
"""
function jacobian!(ψxx::U, ψyy::U, ψxy::U, θx::S, θy::S, D_d::T, θxc::T, θyc::T, k_s::T, θs::T, ϵ::T, pa::T) where {U<:ROA, S<:ROA, T<:Real}
   # Get axis-ratio
   q = (1.0 - ϵ) / (1.0 + ϵ)
   θs_p = θs / sqrt(q)
