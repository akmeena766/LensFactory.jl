...
"""
function potential!(ψ::U, θx::S, θy::S, D_d::T, θxc::T, θyc::T, k_s::T, θs::T, θt::T) where {U<:Real, S<:Real, T<:Real}
   κs = 4.0 * k_s
   τ = θt / θs
...
"""
function potential!(ψ::U, θx::S, θy::S, D_d::T, θxc::T, θyc::T, k_s::T, θs::T, θt::T) where {U<:ROA, S<:ROA, T<:Real}
   κs = 4.0 * k_s
   τ = θt / θs
...
"""
function deflection!(ψx::U, ψy::U, θx::S, θy::S, D_d::T, θxc::T, θyc::T, k_s::T, θs::T, θt::T) where {U<:Real, S<:Real, T<:Real}
   κs = 4.0 * k_s
   τ = θt / θs
...
"""
function  deflection!(ψx::U, ψy::U, θx::S, θy::S, D_d::T, θxc::T, θyc::T, k_s::T, θs::T, θt::T) where {U<:ROA, S<:ROA, T<:Real}
   κs = 4.0 * k_s
   τ = θt / θs
...
"""
function jacobian!(ψxx::U, ψyy::U, ψxy::U, θx::S, θy::S, D_d::T, θxc::T, θyc::T, k_s:: T, θs::T, θt::T) where {U<:Real, S<:Real, T<:Real}
   κs = 4.0 * k_s
   τ = θt / θs
...
"""
function jacobian!(ψxx::U, ψyy::U, ψxy::U, θx::S, θy::S, D_d::T, θxc::T, θyc::T, k_s:: T, θs::T, θt::T) where {U<:ROA, S<:ROA, T<:Real}
   κs = 4.0 * k_s
   τ = θt / θs
