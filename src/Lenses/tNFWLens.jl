...
"""
    potential!(ψ::Real, θx::S, θy::S, D_d::T, θxc::T, θyc::T, k_s::T, θs::T, θt::T) where {S<:Real, T<:Real}
"""
function potential!(ψ::Real, θx::S, θy::S, D_d::T, θxc::T, θyc::T, k_s::T, θs::T, θt::T) where {S<:Real, T<:Real}
   κs = 4.0 * k_s
   τ = θt / θs
...
"""
    potential!(ψ::ROA, θx::S, θy::S, D_d::T, θxc::T, θyc::T, k_s::T, θs::T, θt::T) where {S<:ROA, T<:Real}
"""
function potential!(ψ::ROA, θx::S, θy::S, D_d::T, θxc::T, θyc::T, k_s::T, θs::T, θt::T) where {S<:ROA, T<:Real}
   κs = 4.0 * k_s
   τ = θt / θs
...
"""
    deflection!(ψx::Real, ψy::Real, θx::S, θy::S, D_d::T, θxc::T, θyc::T, k_s::T, θs::T, θt::T) where {S<:Real, T<:Real}
"""
function deflection!(ψx::T, ψy::T, θx::S, θy::S, D_d::T, θxc::T, θyc::T, k_s::T, θs::T, θt::T) where {S<:Real, T<:Real}
   κs = 4.0 * k_s
   τ = θt / θs
...
"""
     deflection!(ψx::T, ψy::T, θx::S, θy::S, D_d::T, θxc::T, θyc::T, k_s::T, θs::T, θt::T) where {S<:ROA, T<:Real}
"""
function  deflection!(ψx::ROA, ψy::ROA, θx::S, θy::S, D_d::T, θxc::T, θyc::T, k_s::T, θs::T, θt::T) where {S<:ROA, T<:Real}
   κs = 4.0 * k_s
   τ = θt / θs
...
"""
    jacobian!(ψxx::Real, ψyy::Real, ψxy::Real, θx::S, θy::S, D_d::T, θxc::T, θyc::T, k_s:: T, θs::T, θt::T) where {S<:Real, T<:Real}
"""
function jacobian!(ψxx::Real, ψyy::Real, ψxy::Real, θx::S, θy::S, D_d::T, θxc::T, θyc::T, k_s:: T, θs::T, θt::T) where {S<:Real, T<:Real}
   κs = 4.0 * k_s
   τ = θt / θs
...
"""
    jacobian!(ψxx::ROA, ψyy::ROA, ψxy::ROA, θx::S, θy::S, D_d::T, θxc::T, θyc::T, k_s:: T, θs::T, θt::T) where {S<:ROA, T<:Real}
"""
function jacobian!(ψxx::ROA, ψyy::ROA, ψxy::ROA, θx::S, θy::S, D_d::T, θxc::T, θyc::T, k_s:: T, θs::T, θt::T) where {S<:ROA, T<:Real}
   κs = 4.0 * k_s
   τ = θt / θs
