...
@inline function L_x(x::Real, τ::Real)
   return log(x / (sqrt(τ^2 + x^2) + τ))
end


"""
    potential!(ψ::T, θx::T, θy::T, D_d::Real, θxc::Real, θyc::Real, k_s:: Real, θs::Real, θt::Real) where T <: Real
"""
function potential!(ψ::T, θx::T, θy::T, D_d::Real, θxc::Real, θyc::Real, k_s:: Real, θs::Real, θt::Real) where T <: Real
   κs = 4.0 * k_s
   τ = θt / θs
...
"""
    potential!(ψ::T, θx::T, θy::T, D_d::Real, θxc::Real, θyc::Real, k_s:: Real, θs::Real, θt::Real) where T <: ROA
"""
function potential!(ψ::T, θx::T, θy::T, D_d::Real, θxc::Real, θyc::Real, k_s:: Real, θs::Real, θt::Real) where T <: ROA
   κs = 4.0 * k_s
   τ = θt / θs
...
"""
    deflection!(ψx::T, ψy::T, θx::T, θy::T, D_d::Real, θxc::Real, θyc::Real, k_s:: Real, θs::Real, θt::Real) where T <: Real
"""
function deflection!(ψx::T, ψy::T, θx::T, θy::T, D_d::Real, θxc::Real, θyc::Real, k_s:: Real, θs::Real, θt::Real) where T <: Real
   κs = 4.0 * k_s
   τ = θt / θs
...
"""
    deflection!(ψx::T, ψy::T, θx::T, θy::T, D_d::Real, θxc::Real, θyc::Real, k_s:: Real, θs::Real, θt::Real) where T <: ROA
"""
function deflection!(ψx::T, ψy::T, θx::T, θy::T, D_d::Real, θxc::Real, θyc::Real, k_s:: Real, θs::Real, θt::Real) where T <: ROA
   κs = 4.0 * k_s
   τ = θt / θs
...
"""
    jacobian!(ψxx::T, ψyy::T, ψxy::T, θx::T, θy::T, D_d::Real, θxc::Real, θyc::Real, k_s:: Real, θs::Real, θt::Real) where T <: Real
"""
function jacobian!(ψxx::T, ψyy::T, ψxy::T, θx::T, θy::T, D_d::Real, θxc::Real, θyc::Real, k_s:: Real, θs::Real, θt::Real) where T <: Real
   κs = 4.0 * k_s
   τ = θt / θs
...
"""
    jacobian!(ψxx::T, ψyy::T, ψxy::T, θx::T, θy::T, D_d::Real, θxc::Real, θyc::Real, k_s:: Real, θs::Real, θt::Real) where T <: ROA
"""
function jacobian!(ψxx::T, ψyy::T, ψxy::T, θx::T, θy::T, D_d::Real, θxc::Real, θyc::Real, k_s:: Real, θs::Real, θt::Real) where T <: ROA
   κs = 4.0 * k_s
   τ = θt / θs
