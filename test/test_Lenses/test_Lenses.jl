...
include("./test_Lenses_SersicLens.jl")
include("./test_Lenses_ExternalEffects.jl")
include("./test_Lenses_ExternalEffects3.jl")
include("./test_Lenses_Multipole.jl")
include("./test_Lenses_PIEPLens.jl")
include("./test_Lenses_SIELens.jl")
include("./test_Lenses_PJELens.jl")
include("./test_Lenses_HernquistLens.jl")
include("./test_Lenses_eHernquistMDLens.jl")
include("./test_Lenses_aHernquistLens.jl")
include("./test_Lenses_NFWLens.jl")
include("./test_Lenses_eNFWMDLens.jl")
include("./test_Lenses_aNFWLens.jl")
include("./test_Lenses_tNFWLens.jl")
# include("./test_Lenses_gNFWLens.jl")
include("./test_Lenses_EinastoLens.jl")
include("./test_Lenses_MultiPlummerLens.jl")
include("./test_Lenses_MultiGaussianLens.jl")
include("./test_Lenses_MultiPJELens.jl")
